...
const devFlag = process.env.NODE_ENV === 'development' || process.argv.indexOf('--open-dev-tools') > -1 || process.argv.indexOf('--open-barrage-dev-tools') > -1
...
export const barrage = {
    ...
    createWindow: () => {
        ...
        if (devFlag) barrageWindow.openDevTools({mode: 'undocked'});
    }
}
